...
## package management
alias pacman="/usr/bin/mullvad-exclude sudo /sbin/pacman"
alias pa="/usr/bin/mullvad-exclude sudo /sbin/pacman"
alias ps="/usr/bin/mullvad-exclude sudo /sbin/pacman -S"
alias pr="/usr/bin/mullvad-exclude sudo /sbin/pacman -R"
alias pq="/usr/bin/mullvad-exclude sudo /sbin/pacman -Q"
alias pqi="/usr/bin/mullvad-exclude sudo /sbin/pacman -Qi"
alias ys="/usr/bin/mullvad-exclude /usr/bin/yay -S"
alias yr="/usr/bin/mullvad-exclude /usr/bin/yay -R"
alias yq="/usr/bin/mullvad-exclude /usr/bin/yay -Q"
alias yqi="/usr/bin/mullvad-exclude /usr/bin/yay -Qi"
...
alias setbattery="bash ~/scripts/batteryThreshold.sh"
